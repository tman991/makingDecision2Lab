...
// Subscripting (accessing values using their index) an array can fail. What happens if you subscript to the 7th element, but there are not 7 elements in the array? Let's write some 
...
//if (myFavoriteNumbers < myFavoriteNumbers[7])
//console.log('There are not enough elements in this array to the console.')


// console.log(myFavoriteNumbers.length)

// if (myFavoriteNumberslength < 7) {
//   console.log('There are not enough elements in this array to the console!')
// }
// else console.log(someNum = myFavoriteNumbers[6])
